...
def main():
    ...
    positions = parse_positions("input_tsv/hs_k562_I_3.tsv", 500)  # .tsv file with selected absolute threshold
    # positions = new_parse_positions("input_cadj/k562.cadj", 500)
    ...
    save_as_bed(P, "output_tsv/hs_k562_I_3.bed")  # save as .bed outfile with cwalks
    pickle.dump(P, open("output_tsv/hs_k562_I_3.txt", "wb"))  # save cwalks as .txt outfile in binary mode
