...
def histogram(data):
    ...
    return plt.savefig(f"hist_cwalks.png"), plt.close()
...
def barh(data, labels):
    ...
    return plt.savefig("cwalk_number.png"), plt.close()
...
def main():
    ...
    collect_data([round(statistics.mean(cwalks_length), 2),
                  ...
                  round(statistics.stdev(cwalks_length), 2)], sys.argv[2], "a")  # "cwalks.tsv"
